    ...
    <body>
        ...
        <div class="cont">
            ...
            <div class="cont_info">
                ...
                <section id="only-one" data-accordion-group>
                    <section data-accordion>
                        <button data-control>
                            <p>Compra Protegida (Robo de mercancía)</p>
                            <span><%=sumaCompraProtegida%> MXN</span></button>
                        <div data-content>
                            <article>Se te reembolsará la suma asegurada contratada en caso de robo de mercancía comprada con tarjetas de crédito, débito y cheques de cualquier banco Visa o MasterCard, siempre que el robo suceda dentro de las 72 horas siguientes al haber realizado la compra. Se te pagará el valor del producto robado hasta la Suma Asegurada por evento indicada en tu caratula de póliza. Puedes usar este beneficio 2 veces al año con un intervalo de 2 meses entre cada evento
							</article>
                        </div>
                    </section>
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Se te cubrirá el robo del efectivo retirado en cualquier cajero, sucursal o corresponsal bancario (tiendas, supermercados, etc), con cargo a las tarjetas de crédito o débito de cualquier banco (Visa o MasterCard), siempre que el robo suceda dentro de las 8 horas posteriores al retiro. Se te pagará el importe retirado y robado, hasta la Suma Asegurada por evento indicada en tu caratula de póliza. Puedes usar este beneficio 2 veces al año con un intervalo de 2 meses entre cada evento
							</article>
                        </div>
                    </section>
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Se te cubrirán las transacciones realizadas a través del portal bancario de Scotiabank por alguien no autorizado por el asegurado, así como el uso fraudulento derivado del robo o extravío de cheques de Scotiabank. Se cubren 72 horas previas al aviso para el bloqueo a la institución bancaria. Se te pagará el valor de las transacciones fraudulentas hasta la Suma Asegurada por evento indicado en tu caratula de póliza. Puedes usar este beneficio 2 veces al año con un intervalo de 2 meses entre cada evento.
							</article>
                        </div>
                    </section>
                    <section data-accordion>
                    ...
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Se te otorgará la suma asegurada contratada para cubrir los gastos el robo de equipos electrónicos portátiles mientras sean propiedades del asegurado o de terceros bajo el cuidado del asegurado al momento del robo. Se cubre un solo evento por la suma asegurada contratada. Aplica un deducible del 15%. La cobertura es efectiva 1 mes después de la contratación. Los equipos que se cubren son: Cámaras de video / fotográficas, Ipods, Consolas de video juegos, GPS, Tabletas / Ipad, Discos duros portátiles, GoPro, Drones, Laptops, Notebooks y Discman. Se cubre hasta agotar la suma asegurada, con un límite máximo de 2 eventos al año, con un intervalo de 2 meses entre eventos.
                            </article>
                        </div>
                    </section>
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Se cubren los gastos que se originen por el reemplazo de documentos personales a consecuencia de un robo, tales como: Pasaporte, Licencia de Conducir, cédula profesional, Títulos escolares, etc. Se cubre hasta agotar la suma asegurada, se cubren máximo 4  eventos al año, con un intervalo de 2 meses entre eventos. La cobertura es efectiva un mes después de la contratación.
							</article>
                        </div>
                    </section>
                    <section data-accordion>
            ...
            <div class="greyBG" style="margin-top: 20px; text-align: justify;">
                ...
                Los servicios de asistencias son proporcionados por Allianz Assistance en caso de requerir de alguno de éstos, comunícate al teléfono <a href="tel:51773843" target="_blank">5177 3843</a>.
            </div>
