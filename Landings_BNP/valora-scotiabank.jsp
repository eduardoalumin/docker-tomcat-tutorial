...
<html>
    ...
    <body>
        <%    int intPlan = Integer.parseInt((String) session.getAttribute("usuarioLogin"));
            ...
            switch (intPlan) {
                case 2591:
                    ...
                    sumaRoboEfectivo = "$60,000";
                    sumaRoboDocumentos = "$3,000";
                    sumaFraudeInternet = "$60,000";
                    sumaCompraProtegida = "$60,000";
                    break;

                case 2592:
                    plan = "Plan Preferente";
                    precioPlanMensual = "$222";
                    sumaRoboCelularTablet = "$8,000";
                    sumaRoboBienesMoviles = "$8,000";
                    sumaRoboObjetosPersonales = "$10,000";
                    sumaRoboEfectivo = "$80,000";
                    sumaRoboDocumentos = "$3,500";
                    sumaFraudeInternet = "$80,000";
                    sumaCompraProtegida = "$80,000";
                    break;

                case 2593:
                    plan = "Plan Premier";
                    precioPlanMensual = "$305";
                    sumaRoboCelularTablet = "$10,000*";
                    sumaRoboBienesMoviles = "$10,000*";
                    sumaRoboObjetosPersonales = "$12,000*";
                    sumaRoboEfectivo = "$100,000";
                    sumaRoboDocumentos = "$4,000";
                    sumaFraudeInternet = "$100,000";
                    sumaCompraProtegida = "$100,000";
                    break;
        ...
        <div class="cont">
            ...
            <div class="bannerScotiaBank_valora"><img src="images/ban_scotiabank_valora_m.jpg"/></div>
            <div class="cont_info">
                ...
                <p><strong>Valora </strong> ofrece protección a <strong>TODAS</strong> las tarjetas de crédito y débito que tengas para darte mayor tranquilidad en eventos inesperados como: </p>
                    ...
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Robo de mercancía comprada con la tarjeta de crédito o débito.<br><br>
								...
								Se pagará el valor del producto robado, sin límite de reclamaciones hasta agotar la suma asegurada, con un intervalo de 30 días entre eventos.
							</article>
                        </div>
                    </section>
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Robo de efectivo con cargo a las tarjetas amparadas.<br><br>
								...
								Se pagará el importe retirado y robado, sin límite de reclamaciones hasta agotar la suma asegurada.
							</article>
                        </div>
                    </section>
                    <section data-accordion>
                        ...
                        <div data-content>
                            <article>Transferencias electrónicas de no reversibles, no autorizadas por el titular a través del sitio de internet de la institución autorizada para transferencias 	  electrónicas y fraude por robo o extravío de cheques.<br><br>
								...
								Se cubren 72 horas previas al aviso para el bloqueo a la institución bancaria. Sin límite de reclamaciones hasta agotar la suma asegurada, con un intervalo de 2 meses entre eventos.
							</article>
                        </div>
                    </section>
                    <section data-accordion>
