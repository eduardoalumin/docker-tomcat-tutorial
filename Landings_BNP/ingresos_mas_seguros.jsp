    ...
    <body>
        <%    int intPlan = Integer.parseInt((String) session.getAttribute("usuarioLogin"));
            ...
            switch (intPlan) {
                case 2505:
                    ...
                    sumaRoboGadgets = "*$11,000";
                    sumaMatrimonio = "$8,250";
                    sumaNacimientoHijo = "$8,250";
                    sumaTitulacion = "$8,250";
                    sumaCancelacionEvento = "Hasta $3,300";
                    sumaFallecimientoFamiliar = "$8,250";
                    sumaDesempleoInvoluntario = "$11,000";
		   			sumaIncapacidadTotalTemporal ="$11,000";
                    break;

                case 2506:
                    plan = "Plan Preferente";
                    precioPlanMensual = "$193";
                    sumaRoboGadgets = "*$11,000";
                    sumaMatrimonio = "$8,800";
                    sumaNacimientoHijo = "$8,800";
                    sumaTitulacion = "$8,800";
                    sumaCancelacionEvento = "Hasta $4,400";
                    sumaFallecimientoFamiliar = "$8,800";
                    sumaDesempleoInvoluntario = "$16,500";
		   			sumaIncapacidadTotalTemporal ="$16,500";
                    break;

                case 2507:
                    plan = "Plan Premier";
                    precioPlanMensual = "$221";
                    sumaRoboGadgets = "*$11,000";
                    sumaMatrimonio = "$9,350";
                    sumaNacimientoHijo = "$9,350";
                    sumaTitulacion = "$9,350";
                    sumaCancelacionEvento = "Hasta $5,500";
                    sumaFallecimientoFamiliar = "$9,350";
                    sumaDesempleoInvoluntario = "$22,000";
		   			sumaIncapacidadTotalTemporal ="$22,000";
                    break;
        ...
        <div class="cont">
            ...
            <div class="greyBG" style="margin-top: 20px; text-align: justify;">
                Los servicios de asistencias son proporcionados por TM-ASSISTANCE en caso de requerir de alguno de éstos, comunícate al teléfono <a href="tel:50149482" target="_blank">50 14 94 82</a> en el área metropolitana o al  <a href="tel:5550149482" target="_blank">55 50 14 94 82</a> desde el interior de la República.
            </div>
