    ...
    <body>
        ...
        <div class="cont">
            ...
            <div style="text-align: center">
                <div class="btFotter2"><a href="download/MX_IG_CGS_CuidadosEsencial_2021-2022_V2.pdf" target="_blank">Condiciones Generales del Seguro</a></div>
                ...
                <div class="btFotter2"><a href="download/MX_IG_Folleto_CuidadosEsencial_2021-2022_VF.pdf" target="_blank">Derechos del Asegurado Cardif</a></div>
            </div>
            <div class="separador"></div>
        </div>
    </body>
